describe('LearnJS', function () {
  ...
  describe('problemView', function () {
    ...
    it('should shows the description', function() {
      expect(view.find('[data-name="description"]').text()).toEqual('What is truth?');
    });

    it('should shows the problem code', function() {
    ...
    describe('answer section', function() {
      ...
      describe('when the answer is correct', function() {
        ...
        it('should flash the result', function() {
        ...
        it('should shows a link to the next problem', function() {
      ...
      describe('when the answer is correct', function() {
        it('should rejects an incorrect answer', function () {
  ...
  describe('flashElement', function () {
    it('should flash an element while setting the text', function() {
      var elem = $('<p>');
  ...
  describe('buildCorrectFlash', function () {
    it('should redirect to the main view after the last problem is answered', function() {
